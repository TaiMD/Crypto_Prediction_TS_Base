...
class Dataset_Custom(Dataset):
    def __init__(self, root_path, flag='train', size=None,
                 features='M', data_path='btc_1h_6f.csv',
                 target='close', scale=True, timeenc=1, freq='h', train_only=False):
    ...
    def __read_data__(self):
        ...
        '''
        cols = list(df_raw.columns) # make a list of all columns
        # print(self.target)
...
class Dataset_Pred(Dataset):
    def __init__(self, root_path, flag='pred', size=None,
                 features='M', data_path='btc_1h_6f.csv',
                 target='close', scale=True, inverse=False, timeenc=1, freq='H', cols=None, train_only=False):
        # size [seq_len, label_len, pred_len]
        # info
        if size == None:
            self.seq_len = 24 * 4 * 4
